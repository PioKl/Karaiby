...
- W niektórych przypadkach lepiej przejść z vh,vw na responsive fluid typography (robionego metodą calc z minimalną i maksymalną wartością). Zapewnia większą pewność, że elementy będą bardzo dobrze wyglądały na urządzeniach o nietypowych rozdzielczościach
- Poprawki w kodzie
...
- Dodać przycisk powrotu na początek strony
