                ...
                <div className="placeToChoose">
                    ...
                    <div className="imagesOfPlacesContainer">
                        <div className="imageOfPlaceContainer imageOfPlaceContainer--left">
                            <img onClick={handlePreviousImage} src={gallery[imageCounter > 0 ? imageCounter > 1 ? imageCounter > 2 ? 2 : 1 : 0 : gallery.length - 1]} alt="zdjęcie miejsca" className="imageOfPlaceContainer__image" />
                        </div>
                        ...
                        <div className="imageOfPlaceContainer imageOfPlaceContainer--right">
                            <img onClick={handleNextImage} src={gallery[imageCounter > 0 ? imageCounter === gallery.length - 1 ? 0 : imageCounter + 1 : 1]} alt="zdjęcie miejsca" className="imageOfPlaceContainer__image" />
                        </div>
                    </div>
